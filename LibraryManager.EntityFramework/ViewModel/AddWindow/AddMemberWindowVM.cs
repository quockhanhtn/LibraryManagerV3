...
{
   public class AddMemberWindowVM : BaseViewModel, IAddNewObject<MemberDTO>
   {
      ...
      public AddMemberWindowVM()
      {
         OKCommand = new RelayCommand<Window>((p) => { return !(p == null); }, (p) =>
         {
            ...
            {
               Id = "",
               LastName = txtLastName.Text.CapitalizeEachWord(),
               FirstName = txtFirstName.Text.CapitalizeEachWord(),
